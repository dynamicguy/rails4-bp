...
class SiteSetting < ActiveRecord::Base
  ...
  # settings available in javascript under Rails4Bp.SiteSettings
  client_setting(:title, "Rails4Bp")
  ...
  # cf. https://github.com/rails4bp/rails4bp/pull/462#issuecomment-14991562
  ...
  # used mainly for dev, force hostname for Rails4Bp.base_url
  ...
  setting(:notification_email, 'info@rails4bp.org')
  ...
  setting(:rails4bp_org_access_key, '')
  ...
  def self.call_rails4bp_hub?
    self.enforce_global_nicknames? && self.rails4bp_org_access_key.present?
  end
