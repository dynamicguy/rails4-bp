module Salmon
 class Slap
    ...
    <rails4bp xmlns="https://joinrails4bp.com/protocol" xmlns:me="http://salmon-protocol.org/ns/magic-env">
      #{header(person)}
      #{@magic_sig.to_xml}
    </rails4bp>
ENTRY
    ...
    def plaintext_header
      header =<<HEADER
    <author_id>#{@author.rails4bp_handle}</author_id>
HEADER
    end
