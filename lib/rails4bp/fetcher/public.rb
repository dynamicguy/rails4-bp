#   Copyright (c) 2010-2012, Rails4Bp Inc.  This file is
#   licensed under the Affero General Public License version 3 or later.  See
#   the COPYRIGHT file.
module Rails4Bp; module Fetcher; class Public
  ...
  # with the given rails4bp_id
  def fetch! rails4bp_id
    @person = Person.by_account_identifier rails4bp_id
  ...
  private
    ...
    def retrieve_and_process_posts
      begin
        ...
        FEDERATION_LOGGER.error "unable to retrieve public posts for #{@person.rails4bp_handle}"
        raise e
      end
      ...
      begin
        ...
        FEDERATION_LOGGER.error "unable to process public posts for #{@person.rails4bp_handle}"
        raise e
      end
    end
    ...
    def retrieve_posts
      ...
      FEDERATION_LOGGER.info "fetching public posts for #{@person.rails4bp_handle}"

      resp = Faraday.get("#{@person.url}people/#{@person.guid}") do |req|
        req.headers[:accept] = 'application/json'
        req.headers[:user_agent] = 'rails4bp-fetcher'
      end
    ...
    def process_posts
      @data.each do |post|
        ...
        entry = StatusMessage.rails4bp_initialize(
          :author => @person,
          :public => true
        )
